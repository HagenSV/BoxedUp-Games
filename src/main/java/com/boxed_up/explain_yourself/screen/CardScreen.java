...
import com.boxed_up.library.Sound;
...
public class CardScreen extends ExplainGameVM.BasicScreen {
    ...
    public void introCards(){
        ...
        if (introAnimationStep == -1){
            ...
            if (gameData.getCardIndex() == 0 ){
                ...
                try {
                    Sound transitionAudio = new Sound(new File("explain_yourself/audio/voting_transition2.wav"));
